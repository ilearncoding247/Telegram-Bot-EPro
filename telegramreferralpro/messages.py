...
class Messages:
    WELCOME_NEW_USER = """🎉 Welcome to the referral system!
...
Click the link above to join the channel, then come back here."""
    ...
    WELCOME_EXISTING_MEMBER = """🎉 Welcome back! I can see you're already a member of {channel_name}.
...
Use /status to check your progress anytime!"""
    ...
    CHANNEL_JOINED_SUCCESS = """✅ Great! You've successfully joined {channel_name}!
...
Use /status to check your progress anytime!"""
    ...
    REFERRAL_WELCOME = """👋 Welcome! You were referred by a friend.
...
After joining, you'll get your own referral link to start earning rewards too!"""
    ...
    STATUS_MESSAGE = """📊 **Your Referral Status**
...
{status_text}"""
    ...
    REWARD_AVAILABLE = """🎉 **CONGRATULATIONS!** 🎉
...
Your referral link is still active: {referral_link}"""
    ...
    HELP_MESSAGE = """🤖 **Referral Bot Commands**
...
- You can check your progress anytime with /status"""
    ...
    ERROR_NOT_CHANNEL_MEMBER = """❌ You need to be a member of the channel first!

Join here: {channel_link}

After joining, come back and use /start again."""
    
    ERROR_REWARD_ALREADY_CLAIMED = """✅ You've already claimed your reward!

Your referral link is still active if you want to keep helping grow the community: {referral_link}"""
    
    ERROR_REWARD_NOT_AVAILABLE = """❌ You haven't reached the referral target yet.
